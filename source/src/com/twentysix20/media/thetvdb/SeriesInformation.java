...
public class SeriesInformation {
	...
	public SeriesInformation(String id, HtmlLoader htmlLoader) throws Exception {
		loadXML(id, htmlLoader);
	}
//MAKE these things LOADERS
//USE model objects directly & add functionality.
	...
	public static void main(String[] args) throws Exception {
    	...
    	System.out.println(new SeriesInformation("Scooby-Doo",loader));
    }
}
